...
def test_google_search():
    ...
    try:
        ...
        try:
            ...
            print("Warning: domcontentloaded timeout, continuing anyway...")
        ...
        try:
            ...
            # Create an empty file so artifact upload doesn't fail
            try:
                with open("search_results.png", "w") as f:
                    f.write("")
            except:
                pass
        ...
        try:
            ...
            try:
                ...
                print("Warning: Search results selector not found, trying to extract anyway...")
        ...
        if page:
            try:
                ...
                try:
                    with open("error_screenshot.png", "w") as f:
                        f.write("")
                except:
                    pass
        
        # Also ensure search_results.png exists
